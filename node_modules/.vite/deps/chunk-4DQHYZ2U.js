...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react7.useMemo)(function() {
...
var Modal = (0, import_react11.forwardRef)((_ref, ref) => {
  ...
  if (Transition2) {
    dialog = (0, import_jsx_runtime7.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime7.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
...
OffcanvasToggling.defaultProps = defaultProps5;
...
var Offcanvas = React11.forwardRef(({
  ...
  const renderBackdrop = (0, import_react12.useCallback)((backdropProps) => (0, import_jsx_runtime11.jsx)("div", {
    ...backdropProps,
...
//# sourceMappingURL=chunk-4DQHYZ2U.js.map
